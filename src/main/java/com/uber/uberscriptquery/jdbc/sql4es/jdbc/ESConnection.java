package com.uber.uberscriptquery.jdbc.sql4es.jdbc;

import com.uber.uberscriptquery.jdbc.sql4es.ESDatabaseMetaData;
    ...
    private Client buildClient() throws SQLException {
        ...
        try {
            ...
            if (props.containsKey("xpack.security.user")) {
                throw new RuntimeException("Not support xpack.security.user");
            } else {
